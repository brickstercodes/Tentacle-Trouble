		...
		public static void OpenBrowser(AirConsole controller, string startUpPath)
		{
			...
			if (controller != null && controller.enabled)
			{
				...
				if (controller.controllerHtml != null)
				{
					...
					// Skip copy - always use the existing controller.html in WebGLTemplates
					// This avoids file locking issues. Manually copy your controller.html to WebGLTemplates if you change it.
